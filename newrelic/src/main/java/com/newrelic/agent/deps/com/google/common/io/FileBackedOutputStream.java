    ...
    public synchronized void reset() throws IOException {
        try {
            ...
            if (this.file != null) {
                ...
                this.file = null;
                if (!deleteMe.delete()) {
                    final String value = String.valueOf(String.valueOf(deleteMe));
                    throw new IOException(new StringBuilder(18 + value.length()).append("Could not delete: ").append(value).toString());
                }
            }
        }
    }
