...
public abstract class BaseEncoding
{
    ...
    static final class SeparatedBaseEncoding extends BaseEncoding
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(31 + value.length() + value2.length()).append(value).append(".withSeparator(\"").append(value2).append("\", ").append(this.afterEveryChars).append(")").toString();
        }
    }
}
