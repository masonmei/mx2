...
public class Metaphone implements StringEncoder
{
    ...
    public String metaphone(final String txt) {
        ...
        final StringBuffer local = new StringBuffer(40);
        final StringBuffer code = new StringBuffer(10);
        switch (inwd[0]) {
            case 'G':
            case 'K':
            case 'P': {
    ...
    private boolean isVowel(final StringBuffer string, final int index) {
        return "AEIOU".indexOf(string.charAt(index)) >= 0;
    }
    
    private boolean isPreviousChar(final StringBuffer string, final int index, final char c) {
    ...
    private boolean isNextChar(final StringBuffer string, final int index, final char c) {
        boolean matches = false;
    ...
    private boolean regionMatch(final StringBuffer string, final int index, final String test) {
        boolean matches = false;
    ...
    public Object encode(final Object pObject) throws EncoderException {
        ...
        return this.metaphone((String)pObject);
    }
    
    public String encode(final String pString) {
        return this.metaphone(pString);
    }
