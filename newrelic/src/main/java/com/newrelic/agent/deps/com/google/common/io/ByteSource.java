...
import com.newrelic.agent.deps.com.google.common.hash.Hasher;
import com.newrelic.agent.deps.com.google.common.hash.PrimitiveSink;
import com.newrelic.agent.deps.com.google.common.hash.Funnels;
...
public abstract class ByteSource
{
    ...
    private final class AsCharSource extends CharSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(15 + value.length() + value2.length()).append(value).append(".asCharSource(").append(value2).append(")").toString();
        }
    }
    ...
    private final class SlicedByteSource extends ByteSource
    {
        ...
        public String toString() {
            final String value = String.valueOf(String.valueOf(ByteSource.this.toString()));
            return new StringBuilder(50 + value.length()).append(value).append(".slice(").append(this.offset).append(", ").append(this.length).append(")").toString();
        }
    }
    ...
    private static class ByteArrayByteSource extends ByteSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(17 + value.length()).append("ByteSource.wrap(").append(value).append(")").toString();
        }
    }
    ...
    private static final class ConcatenatedByteSource extends ByteSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(19 + value.length()).append("ByteSource.concat(").append(value).append(")").toString();
        }
    }
}
