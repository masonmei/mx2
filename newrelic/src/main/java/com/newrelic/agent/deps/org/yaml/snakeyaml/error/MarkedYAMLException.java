...
public class MarkedYAMLException extends YAMLException
{
    ...
    public String toString() {
        ...
        if (this.contextMark != null && (this.problem == null || this.problemMark == null || this.contextMark.getName() != this.problemMark.getName() || this.contextMark.getLine() != this.problemMark.getLine() || this.contextMark.getColumn() != this.problemMark.getColumn())) {
