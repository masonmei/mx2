...
public class PhoneticEngine
{
    ...
    private PhonemeBuilder applyFinalRules(final PhonemeBuilder phonemeBuilder, final List<Rule> finalRules) {
        ...
        for (final Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            for (int i = 0; i < phonemeText.length(); i = rulesApplication.getI()) {
                rulesApplication = new RulesApplication(finalRules, phonemeText, subBuilder, i).invoke();
    ...
    public String encode(String input, final Languages.LanguageSet languageSet) {
        ...
        for (int i = 0; i < inputCache.length(); i = rulesApplication.getI(), phonemeBuilder = rulesApplication.getPhonemeBuilder()) {
            rulesApplication = new RulesApplication(rules, inputCache, phonemeBuilder, i).invoke();
        }
    ...
    static final class PhonemeBuilder
    {
        ...
        public PhonemeBuilder append(final CharSequence str) {
            final Set<Rule.Phoneme> newPhonemes = new HashSet<Rule.Phoneme>();
        ...
        public PhonemeBuilder apply(final Rule.PhonemeExpr phonemeExpr) {
            final Set<Rule.Phoneme> newPhonemes = new HashSet<Rule.Phoneme>();
    ...
    private static final class RulesApplication
    {
        ...
        public RulesApplication(final List<Rule> finalRules, final CharSequence input, final PhonemeBuilder phonemeBuilder, final int i) {
            if (finalRules == null) {
