...
import com.newrelic.agent.deps.com.google.common.collect.AbstractSequentialIterator;
...
import com.newrelic.agent.deps.com.google.common.util.concurrent.Uninterruptibles;
...
import com.newrelic.agent.deps.com.google.common.util.concurrent.ExecutionError;
import com.newrelic.agent.deps.com.google.common.util.concurrent.UncheckedExecutionException;
...
import com.newrelic.agent.deps.com.google.common.base.Ticker;
import java.util.Queue;
import com.newrelic.agent.deps.com.google.common.base.Equivalence;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>
{
            ...
            if (!keysToLoad.isEmpty()) {
                try {
                    ...
                    for (final K key2 : keysToLoad) {
                        ...
                        if (value2 == null) {
                            final String value3 = String.valueOf(String.valueOf(key2));
                            throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(37 + value3.length()).append("loadAll failed to return a value for ").append(value3).toString());
                        }
    ...
    Map<K, V> loadAll(final Set<? extends K> keys, final CacheLoader<? super K, V> loader) throws ExecutionException {
        ...
        if (result == null) {
            this.globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
            final String value2 = String.valueOf(String.valueOf(loader));
            throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(31 + value2.length()).append(value2).append(" returned null map from loadAll").toString());
        }
        stopwatch.stop();
        ...
        if (nullsPresent) {
            this.globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
            final String value3 = String.valueOf(String.valueOf(loader));
            throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(42 + value3.length()).append(value3).append(" returned null keys or values from loadAll").toString());
        }
    ...
    static class Segment<K, V> extends ReentrantLock
    {
        ...
        V waitForLoadingValue(final ReferenceEntry<K, V> e, final K key, final ValueReference<K, V> valueReference) throws ExecutionException {
            ...
            try {
                ...
                if (value == null) {
                    final String value2 = String.valueOf(String.valueOf(key));
                    throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(35 + value2.length()).append("CacheLoader returned null for key ").append(value2).append(".").toString());
                }
                final long now = this.map.ticker.read();
                this.recordRead(e, now);
                return value;
    ...
    interface ReferenceEntry<K, V>
    {
        ...
        void setValueReference(ValueReference<K, V> p0);
        ...
        void setNextInAccessQueue(ReferenceEntry<K, V> p0);
        
        ReferenceEntry<K, V> getPreviousInAccessQueue();
        
        void setPreviousInAccessQueue(ReferenceEntry<K, V> p0);
        ...
        void setNextInWriteQueue(ReferenceEntry<K, V> p0);
        
        ReferenceEntry<K, V> getPreviousInWriteQueue();
        
        void setPreviousInWriteQueue(ReferenceEntry<K, V> p0);
    }
    ...
    interface ValueReference<K, V>
    {
        ...
        ValueReference<K, V> copyFor(ReferenceQueue<V> p0, @Nullable V p1, ReferenceEntry<K, V> p2);
        
        void notifyNewValue(@Nullable V p0);
