...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable
{
    ...
    private abstract static class ArrayMap<K, V> extends Maps.ImprovedAbstractMap<K, V>
    {
        ...
        public V put(final K key, final V value) {
            final Integer index = this.keyIndex.get(key);
            if (index == null) {
                final String value2 = String.valueOf(String.valueOf(this.getKeyRole()));
                final String value3 = String.valueOf(String.valueOf(key));
                final String value4 = String.valueOf(String.valueOf(this.keyIndex.keySet()));
                throw new IllegalArgumentException(new StringBuilder(9 + value2.length() + value3.length() + value4.length()).append(value2).append(" ").append(value3).append(" not in ").append(value4).toString());
            }
