...
import com.newrelic.agent.deps.javassist.CtPrimitiveType;
...
public class JvstCodeGen extends MemberCodeGen
{
    ...
    public void atMember(final Member mem) throws CompileError {
        ...
        if (name.equals(this.paramArrayName)) {
            ...
            this.bytecode.addInvokestatic("com/newrelic/agent/deps/javassist/runtime/Desc", "getParams", "(Ljava/lang/String;)[Ljava/lang/Class;");
            this.exprType = 307;
            this.arrayDim = 1;
    ...
    private void callGetType(final String method) {
        this.bytecode.addInvokestatic("com/newrelic/agent/deps/javassist/runtime/Desc", method, "(Ljava/lang/String;)Ljava/lang/Class;");
        this.exprType = 307;
        this.arrayDim = 0;
        this.className = "java/lang/Class";
    }
    ...
    protected void atCflow(final ASTList cname) throws CompileError {
        ...
        this.bytecode.addInvokevirtual("com.newrelic.agent.deps.javassist.runtime.Cflow", "value", "()I");
        this.exprType = 324;
        this.arrayDim = 0;
        this.className = null;
    }
