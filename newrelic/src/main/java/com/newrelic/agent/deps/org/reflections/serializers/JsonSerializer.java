...
import com.newrelic.agent.deps.com.google.common.collect.*;
import com.newrelic.agent.deps.com.google.common.io.Files;
import com.newrelic.agent.deps.com.google.gson.*;
    ...
    private Gson getGson() {
        if (gson == null) {
            gson = new GsonBuilder()
                    .registerTypeAdapter(Multimap.class, new com.newrelic.agent.deps.com.google.gson.JsonSerializer<Multimap>() {
                        public JsonElement serialize(Multimap multimap, Type type,
                    ...
                    .registerTypeAdapter(Multimap.class, new JsonDeserializer<Multimap>() {
                        public Multimap deserialize(JsonElement jsonElement, Type type,
                                                    JsonDeserializationContext jsonDeserializationContext)
                                throws JsonParseException {
                            final SetMultimap<String, String> map
