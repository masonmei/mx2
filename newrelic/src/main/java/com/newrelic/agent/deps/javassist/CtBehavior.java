...
import com.newrelic.agent.deps.javassist.bytecode.LineNumberAttribute;
import com.newrelic.agent.deps.javassist.bytecode.CodeIterator;
import com.newrelic.agent.deps.javassist.expr.ExprEditor;
import com.newrelic.agent.deps.javassist.bytecode.StackMap;
import com.newrelic.agent.deps.javassist.bytecode.StackMapTable;
import com.newrelic.agent.deps.javassist.bytecode.LocalVariableTypeAttribute;
...
import com.newrelic.agent.deps.javassist.compiler.Javac;
...
import com.newrelic.agent.deps.javassist.bytecode.SignatureAttribute;
    ...
    public void useCflow(final String name) throws CannotCompileException {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    final CtClass type = pool.get("com.newrelic.agent.deps.javassist.runtime.Cflow");
