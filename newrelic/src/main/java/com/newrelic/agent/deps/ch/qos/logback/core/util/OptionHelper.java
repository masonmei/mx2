...
import com.newrelic.agent.deps.ch.qos.logback.core.subst.NodeToStringTransformer;
...
public class OptionHelper
{
    ...
    public static void setSystemProperties(final ContextAware contextAware, final Properties props) {
        for (final Object o : ((Hashtable<Object, V>)props).keySet()) {
