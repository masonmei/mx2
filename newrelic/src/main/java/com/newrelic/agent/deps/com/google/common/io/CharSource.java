...
public abstract class CharSource
{
    ...
    private static class CharSequenceCharSource extends CharSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(17 + value.length()).append("CharSource.wrap(").append(value).append(")").toString();
        }
    ...
    private static final class ConcatenatedCharSource extends CharSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(19 + value.length()).append("CharSource.concat(").append(value).append(")").toString();
        }
    }
}
