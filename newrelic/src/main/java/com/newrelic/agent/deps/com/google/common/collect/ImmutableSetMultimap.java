    ...
    private void readObject(final ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < keyCount; ++i) {
            ...
            if (valueSet.size() != array.length) {
                final String value = String.valueOf(String.valueOf(key));
                throw new InvalidObjectException(new StringBuilder(40 + value.length()).append("Duplicate key-value pairs exist for key ").append(value).toString());
            }
