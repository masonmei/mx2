...
import java.io.File;
import com.newrelic.agent.deps.com.google.common.collect.TreeTraverser;
...
public final class Files
{
    ...
    public static File createTempDir() {
        ...
        for (int counter = 0; counter < 10000; ++counter) {
            final File file = baseDir;
            final String value = String.valueOf(String.valueOf(baseName));
            final File tempDir = new File(file, new StringBuilder(11 + value.length()).append(value).append(counter).toString());
            if (tempDir.mkdir()) {
                return tempDir;
            }
        }
        final String value2 = String.valueOf(String.valueOf("Failed to create directory within 10000 attempts (tried "));
        final String value3 = String.valueOf(String.valueOf(baseName));
        final String value4 = String.valueOf(String.valueOf(baseName));
        throw new IllegalStateException(new StringBuilder(17 + value2.length() + value3.length() + value4.length()).append(value2).append(value3).append("0 to ").append(value4).append(9999).append(")").toString());
    }
    ...
    public static void touch(final File file) throws IOException {
        ...
        if (!file.createNewFile() && !file.setLastModified(System.currentTimeMillis())) {
            ...
            throw new IOException(new StringBuilder(38 + value.length()).append("Unable to update modification time of ").append(value).toString());
        }
    }
    ...
    public static void createParentDirs(final File file) throws IOException {
        ...
        if (!parent.isDirectory()) {
            final String value = String.valueOf(String.valueOf(file));
            throw new IOException(new StringBuilder(39 + value.length()).append("Unable to create parent directories of ").append(value).toString());
        }
    }
    ...
    public static void move(final File from, final File to) throws IOException {
        ...
        if (!from.renameTo(to)) {
            ...
            if (!from.delete()) {
                if (!to.delete()) {
                    final String value = String.valueOf(String.valueOf(to));
                    throw new IOException(new StringBuilder(17 + value.length()).append("Unable to delete ").append(value).toString());
                }
                final String value2 = String.valueOf(String.valueOf(from));
                throw new IOException(new StringBuilder(17 + value2.length()).append("Unable to delete ").append(value2).toString());
            }
        }
    }
    ...
    public static String simplifyPath(final String pathname) {
        ...
        if (pathname.charAt(0) == '/') {
            ...
            result = ((value.length() != 0) ? s.concat(value) : new String(s));
        }
    ...
    private static final class FileByteSource extends ByteSource
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(20 + value.length()).append("Files.asByteSource(").append(value).append(")").toString();
        }
    }
    ...
    private static final class FileByteSink extends ByteSink
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(20 + value.length() + value2.length()).append("Files.asByteSink(").append(value).append(", ").append(value2).append(")").toString();
        }
    }
