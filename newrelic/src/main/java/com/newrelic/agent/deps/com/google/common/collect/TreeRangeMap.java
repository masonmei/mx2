    ...
    static {
        EMPTY_SUB_RANGE_MAP = new RangeMap() {
            ...
            public void put(final Range range, final Object value) {
                ...
                throw new IllegalArgumentException(new StringBuilder(46 + value2.length()).append("Cannot insert range ").append(value2).append(" into an empty subRangeMap").toString());
            }
