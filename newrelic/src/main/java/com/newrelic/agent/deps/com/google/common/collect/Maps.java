...
public final class Maps
{
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V>
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(4 + value.length() + value2.length()).append("(").append(value).append(", ").append(value2).append(")").toString();
        }
    }
    ...
    private static class AsMapView<K, V> extends ImprovedAbstractMap<K, V>
    {
        ...
        public V get(@Nullable final Object key) {
            if (Collections2.safeContains(this.backingSet(), key)) {
                return this.function.apply((Object)key);
            }
            return null;
        }
    ...
    private static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(18 + value.length()).append("Maps.asConverter(").append(value).append(")").toString();
        }
    }
    ...
    {
        V2 transformEntry(@Nullable K p0, @Nullable V1 p1);
    }
}
