...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V>
{
    ...
    private static final <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(final Iterable<Table.Cell<R, C, V>> cells, @Nullable final Comparator<? super R> rowComparator, @Nullable final Comparator<? super C> columnComparator) {
        ...
        return (RegularImmutableTable<R, C, V>)((cellList.size() > rowSpace.size() * columnSpace.size() / 2L) ? new DenseImmutableTable<R, C, V>((ImmutableList<Table.Cell<Object, Object, Object>>)cellList, (ImmutableSet<Object>)rowSpace, (ImmutableSet<Object>)columnSpace) : new SparseImmutableTable<R, C, V>((ImmutableList<Table.Cell<Object, Object, Object>>)cellList, (ImmutableSet<Object>)rowSpace, (ImmutableSet<Object>)columnSpace));
    }
