...
public final class MoreExecutors
{
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            return (ThreadFactory)Class.forName("com.newrelic.agent.deps.com.google.appengine.api.ThreadManager").getMethod("currentRequestThreadFactory", (Class<?>[])new Class[0]).invoke(null, new Object[0]);
        }
    ...
    private static boolean isAppEngine() {
        if (System.getProperty("com.newrelic.agent.deps.com.google.appengine.runtime.environment") == null) {
            return false;
        }
        try {
            return Class.forName("com.newrelic.agent.deps.com.google.apphosting.api.ApiProxy").getMethod("getCurrentEnvironment", (Class<?>[])new Class[0]).invoke(null, new Object[0]) != null;
        }
    ...
    static class Application
    {
        ...
        final void addDelayedShutdownHook(final ExecutorService service, final long terminationTimeout, final TimeUnit timeUnit) {
            ...
            this.addShutdownHook(MoreExecutors.newThread(new StringBuilder(24 + value.length()).append("DelayedShutdownHook-for-").append(value).toString(), new Runnable() {
                @Override
                public void run() {
                    try {
                        service.shutdown();
