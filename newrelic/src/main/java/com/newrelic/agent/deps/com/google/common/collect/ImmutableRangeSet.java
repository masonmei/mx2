...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable
{
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        final ImmutableRangeSet complement = new ImmutableRangeSet<C>(complementRanges, this);
        this.complement = (ImmutableRangeSet<C>)complement;
        result = (ImmutableRangeSet<C>)complement;
        return result;
    }
    ...
    public static class Builder<C extends Comparable<?>>
    {
        ...
        public Builder<C> add(final Range<C> range) {
            if (range.isEmpty()) {
                final String value = String.valueOf(String.valueOf(range));
                throw new IllegalArgumentException(new StringBuilder(33 + value.length()).append("range must not be empty, but was ").append(value).toString());
            }
