...
import com.newrelic.agent.deps.javassist.bytecode.StackMapTable;
...
import com.newrelic.agent.deps.javassist.bytecode.DuplicateMemberException;
...
public class ProxyFactory
{
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "com.newrelic.agent.deps.javassist.util.proxy.RuntimeSupport";
    ...
    private static MethodInfo makeConstructor(final String thisClassName, final Constructor cons, final ConstPool cp, final Class superClass, final boolean doHandlerInit) {
        ...
        code.addAload(0);
        code.addGetstatic("com.newrelic.agent.deps.javassist.util.proxy.RuntimeSupport", "default_interceptor", ProxyFactory.HANDLER_TYPE);
        code.addPutfield(thisClassName, "handler", ProxyFactory.HANDLER_TYPE);
    ...
    private static MethodInfo makeWriteReplace(final ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("com.newrelic.agent.deps.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
        code.addOpcode(176);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
