...
package com.newrelic.agent.deps.javassist.tools.web;
...
public class Viewer extends ClassLoader
{
    ...
    protected Class findClass(final String name) throws ClassNotFoundException {
        Class c = null;
        if (name.startsWith("java.") || name.startsWith("javax.") || name.equals("com.newrelic.agent.deps.javassist.tools.web.Viewer")) {
