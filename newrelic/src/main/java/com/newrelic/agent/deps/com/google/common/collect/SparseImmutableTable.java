    ...
    SparseImmutableTable(final ImmutableList<Table.Cell<R, C, V>> cellList, final ImmutableSet<R> rowSpace, final ImmutableSet<C> columnSpace) {
        ...
        for (int i = 0; i < cellList.size(); ++i) {
            ...
            if (oldValue != null) {
                ...
                final String value5 = String.valueOf(String.valueOf(oldValue));
                throw new IllegalArgumentException(new StringBuilder(37 + value2.length() + value3.length() + value4.length() + value5.length()).append("Duplicate value for row=").append(value2).append(", column=").append(value3).append(": ").append(value4).append(", ").append(value5).toString());
            }
