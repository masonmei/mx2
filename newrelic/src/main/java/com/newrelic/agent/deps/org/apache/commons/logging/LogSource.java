...
import com.newrelic.agent.deps.org.apache.commons.logging.impl.NoOpLog;
...
public class LogSource
{
    ...
    static {
        ...
        try {
            LogSource.jdk14IsAvailable = (null != Class.forName("java.util.logging.Logger") && null != Class.forName("com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger"));
        }
        catch (Throwable t) {
            LogSource.jdk14IsAvailable = false;
        }
        String name = null;
        try {
            name = System.getProperty("com.newrelic.agent.deps.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("com.newrelic.agent.deps.org.apache.commons.logging.Log");
            }
        }
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation("com.newrelic.agent.deps.org.apache.commons.logging.impl.NoOpLog");
                }
                catch (Throwable t4) {}
            }
        }
            ...
            try {
                if (LogSource.log4jIsAvailable) {
                    setLogImplementation("com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger");
                }
                else if (LogSource.jdk14IsAvailable) {
                    setLogImplementation("com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger");
                }
                else {
                    setLogImplementation("com.newrelic.agent.deps.org.apache.commons.logging.impl.NoOpLog");
                }
