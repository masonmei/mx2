...
public final class Functions
{
    ...
    private static class FunctionForMapNoDefault<K, V> implements Function<K, V>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(8 + value.length()).append("forMap(").append(value).append(")").toString();
        }
    }
    ...
    private static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(23 + value.length() + value2.length()).append("forMap(").append(value).append(", defaultValue=").append(value2).append(")").toString();
        }
    }
    ...
    private static class PredicateFunction<T> implements Function<T, Boolean>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(14 + value.length()).append("forPredicate(").append(value).append(")").toString();
        }
    }
    ...
    private static class ConstantFunction<E> implements Function<Object, E>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(10 + value.length()).append("constant(").append(value).append(")").toString();
        }
    }
    ...
    private static class SupplierFunction<T> implements Function<Object, T>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(13 + value.length()).append("forSupplier(").append(value).append(")").toString();
        }
    }
}
