...
public final class Sets
{
    ...
    public static <E extends Enum<E>> ImmutableSet<E> immutableEnumSet(final E anElement, final E... otherElements) {
        return ImmutableEnumSet.asImmutable((EnumSet<E>)EnumSet.of((E)anElement, (E[])otherElements));
    }
    ...
    private static final class PowerSet<E> extends AbstractSet<Set<E>>
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(10 + value.length()).append("powerSet(").append(value).append(")").toString();
        }
    }
    ...
    static final class UnmodifiableNavigableSet<E> extends ForwardingSortedSet<E> implements NavigableSet<E>, Serializable
    {
        ...
        public NavigableSet<E> descendingSet() {
            ...
            if (result == null) {
                final UnmodifiableNavigableSet descendingSet = new UnmodifiableNavigableSet<E>(this.delegate.descendingSet());
