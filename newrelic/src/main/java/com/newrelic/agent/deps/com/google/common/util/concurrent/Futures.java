...
public final class Futures
{
    ...
    public static <V> ListenableFuture<List<V>> allAsList(final ListenableFuture<? extends V>... futures) {
        return listFuture((ImmutableList<ListenableFuture<? extends V>>)ImmutableList.copyOf((ListenableFuture<? extends V>[])futures), true, MoreExecutors.directExecutor());
    }
    ...
    public static <V> ListenableFuture<List<V>> successfulAsList(final ListenableFuture<? extends V>... futures) {
        return listFuture((ImmutableList<ListenableFuture<? extends V>>)ImmutableList.copyOf((ListenableFuture<? extends V>[])futures), false, MoreExecutors.directExecutor());
    }
    ...
    private static <X extends Exception> X newWithCause(final Class<X> exceptionClass, final Throwable cause) {
        ...
        final String value = String.valueOf(String.valueOf(exceptionClass));
        throw new IllegalArgumentException(new StringBuilder(82 + value.length()).append("No appropriate constructor for exception of type ").append(value).append(" in response to chained exception").toString(), cause);
    }
    ...
    private abstract static class ImmediateFuture<V> implements ListenableFuture<V>
    {
        ...
        public void addListener(final Runnable listener, final Executor executor) {
            ...
            try {
                ...
                final String value = String.valueOf(String.valueOf(listener));
    ...
    private static final class WrappedCombiner<T> implements Callable<T>
    {
        ...
        WrappedCombiner(final Callable<T> delegate) {
