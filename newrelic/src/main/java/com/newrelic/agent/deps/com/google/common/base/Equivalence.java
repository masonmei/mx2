...
public abstract class Equivalence<T>
{
    ...
    public static final class Wrapper<T> implements Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(7 + value.length() + value2.length()).append(value).append(".wrap(").append(value2).append(")").toString();
        }
    }
    ...
    private static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(15 + value.length() + value2.length()).append(value).append(".equivalentTo(").append(value2).append(")").toString();
        }
    }
