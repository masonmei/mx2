...
public abstract class CharMatcher implements Predicate<Character>
{
    ...
    public static CharMatcher is(final char match) {
        final String value = String.valueOf(String.valueOf(showCharacter(match)));
        final String description = new StringBuilder(18 + value.length()).append("CharMatcher.is('").append(value).append("')").toString();
    ...
    public static CharMatcher isNot(final char match) {
        final String value = String.valueOf(String.valueOf(showCharacter(match)));
        final String description = new StringBuilder(21 + value.length()).append("CharMatcher.isNot('").append(value).append("')").toString();
        return new FastMatcher(description) {
            @Override
            public boolean matches(final char c) {
                return c != match;
    ...
    private static CharMatcher isEither(final char match1, final char match2) {
        final String value = String.valueOf(String.valueOf(showCharacter(match1)));
        final String value2 = String.valueOf(String.valueOf(showCharacter(match2)));
        final String description = new StringBuilder(21 + value.length() + value2.length()).append("CharMatcher.anyOf(\"").append(value).append(value2).append("\")").toString();
        return new FastMatcher(description) {
            @Override
            public boolean matches(final char c) {
    ...
    public static CharMatcher inRange(final char startInclusive, final char endInclusive) {
        ...
        final String value = String.valueOf(String.valueOf(showCharacter(startInclusive)));
        final String value2 = String.valueOf(String.valueOf(showCharacter(endInclusive)));
        final String description = new StringBuilder(27 + value.length() + value2.length()).append("CharMatcher.inRange('").append(value).append("', '").append(value2).append("')").toString();
    ...
    public static CharMatcher forPredicate(final Predicate<? super Character> predicate) {
        ...
        final String value = String.valueOf(String.valueOf(predicate));
        final String description = new StringBuilder(26 + value.length()).append("CharMatcher.forPredicate(").append(value).append(")").toString();
    ...
    CharMatcher precomputedInternal() {
        ...
        if (this.description.endsWith(suffix)) {
            substring = this.description.substring(0, this.description.length() - suffix.length());
        }
        else {
            final String value = String.valueOf(this.description);
            final String value2 = String.valueOf(suffix);
            substring = ((value2.length() != 0) ? value.concat(value2) : new String(value));
        }
        final String negatedDescription = substring;
    ...
    private static class NegatedMatcher extends CharMatcher
    {
        ...
        NegatedMatcher(final CharMatcher original) {
            final String value = String.valueOf(String.valueOf(original));
            this(new StringBuilder(9 + value.length()).append(value).append(".negate()").toString(), original);
        }
    ...
    private static class And extends CharMatcher
    {
        ...
        And(final CharMatcher a, final CharMatcher b) {
            final String value = String.valueOf(String.valueOf(a));
            final String value2 = String.valueOf(String.valueOf(b));
            this(a, b, new StringBuilder(19 + value.length() + value2.length()).append("CharMatcher.and(").append(value).append(", ").append(value2).append(")").toString());
        }
    ...
    private static class Or extends CharMatcher
    {
        ...
        Or(final CharMatcher a, final CharMatcher b) {
            final String value = String.valueOf(String.valueOf(a));
            final String value2 = String.valueOf(String.valueOf(b));
            this(a, b, new StringBuilder(18 + value.length() + value2.length()).append("CharMatcher.or(").append(value).append(", ").append(value2).append(")").toString());
        }
