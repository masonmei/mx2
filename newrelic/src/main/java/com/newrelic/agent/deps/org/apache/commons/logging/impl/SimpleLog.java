...
public class SimpleLog implements Log, Serializable
{
    ...
    protected static final String systemPrefix = "com.newrelic.agent.deps.org.apache.commons.logging.simplelog.";
    ...
    public SimpleLog(String name) {
        ...
        this.logName = name;
        this.setLevel(3);
        String lvl = getStringProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.log." + this.logName);
        for (int i = String.valueOf(name).lastIndexOf("."); null == lvl && i > -1; lvl = getStringProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.log." + name), i = String.valueOf(name).lastIndexOf(".")) {
            name = name.substring(0, i);
        }
        if (null == lvl) {
            lvl = getStringProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.defaultlog");
        }
    ...
    private static ClassLoader getContextClassLoader() {
        ...
        try {
            final Method method = ((SimpleLog.class$java$lang$Thread == null) ? (SimpleLog.class$java$lang$Thread = class$("java.lang.Thread")) : SimpleLog.class$java$lang$Thread).getMethod("getContextClassLoader", (Class[])null);
            try {
        ...
        if (classLoader == null) {
            classLoader = ((SimpleLog.class$org$apache$commons$logging$impl$SimpleLog == null) ? (SimpleLog.class$org$apache$commons$logging$impl$SimpleLog = class$("com.newrelic.agent.deps.org.apache.commons.logging.impl.SimpleLog")) : SimpleLog.class$org$apache$commons$logging$impl$SimpleLog).getClassLoader();
        }
        return classLoader;
    }
    ...
    static {
        ...
        SimpleLog.showLogName = getBooleanProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.showlogname", SimpleLog.showLogName);
        SimpleLog.showShortName = getBooleanProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.showShortLogname", SimpleLog.showShortName);
        SimpleLog.showDateTime = getBooleanProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.showdatetime", SimpleLog.showDateTime);
        if (SimpleLog.showDateTime) {
            SimpleLog.dateTimeFormat = getStringProperty("com.newrelic.agent.deps.org.apache.commons.logging.simplelog.dateTimeFormat", SimpleLog.dateTimeFormat);
            try {
