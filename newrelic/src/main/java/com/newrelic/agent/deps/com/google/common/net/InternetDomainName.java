...
import com.newrelic.agent.deps.com.google.thirdparty.publicsuffix.PublicSuffixPatterns;
...
public final class InternetDomainName
{
    ...
    public InternetDomainName child(final String leftParts) {
        final String value = String.valueOf(String.valueOf(Preconditions.checkNotNull(leftParts)));
        final String value2 = String.valueOf(String.valueOf(this.name));
        return from(new StringBuilder(1 + value.length() + value2.length()).append(value).append(".").append(value2).toString());
    }
