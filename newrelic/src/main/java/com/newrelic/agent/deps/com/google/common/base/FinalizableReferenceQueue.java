...
public class FinalizableReferenceQueue implements Closeable
{
    ...
    private static final String FINALIZER_CLASS_NAME = "com.newrelic.agent.deps.com.google.common.base.internal.Finalizer";
    ...
    static {
        FinalizableReferenceQueue.class.getName();
    ...
    static class SystemLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            ...
            if (systemLoader != null) {
                try {
                    return systemLoader.loadClass("com.newrelic.agent.deps.com.google.common.base.internal.Finalizer");
                }
    ...
    static class DecoupledLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                return finalizerLoader.loadClass("com.newrelic.agent.deps.com.google.common.base.internal.Finalizer");
            }
            catch (Exception e) {
        ...
        URL getBaseUrl() throws IOException {
            final String finalizerPath = String.valueOf("com.newrelic.agent.deps.com.google.common.base.internal.Finalizer".replace('.', '/')).concat(".class");
            ...
            if (!urlString.endsWith(finalizerPath)) {
                ...
                final String value = String.valueOf(urlString);
    ...
    static class DirectLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                return Class.forName("com.newrelic.agent.deps.com.google.common.base.internal.Finalizer");
            }
