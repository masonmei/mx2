...
import static com.newrelic.agent.deps.org.reflections.util.Utils.isEmpty;
 ...
 *     <ul>
 *         <li>{@link #getAllSuperTypes(Class, com.newrelic.agent.deps.com.google.common.base.Predicate...)}
 *         <li>{@link #getAllFields(Class, com.newrelic.agent.deps.com.google.common.base.Predicate...)}
 *         <li>{@link #getAllMethods(Class, com.newrelic.agent.deps.com.google.common.base.Predicate...)}
 *         <li>{@link #getAllConstructors(Class, com.newrelic.agent.deps.com.google.common.base.Predicate...)}
 *     </ul>
...
public abstract class ReflectionUtils {
    ...
    /** would include {@code Object.class} when {@link #getAllSuperTypes(Class, com.newrelic.agent.deps.com.google.common.base.Predicate[])}. default is false. */
     ...
     * <p>if optional {@link ClassLoader}s are not specified, then both {@link com.newrelic.agent.deps.org.reflections.util.ClasspathHelper#contextClassLoader()} and {@link com.newrelic.agent.deps.org.reflections.util.ClasspathHelper#staticClassLoader()} are used
     * */
