...
public class Lang
{
    ...
    private static final String LANGUAGE_RULES_RN = "com/newrelic/agent/deps/org/apache/commons/codec/language/bm/lang.txt";
    ...
    static {
        ...
        for (final NameType s : NameType.values()) {
            Lang.Langs.put(s, loadFromResource("com/newrelic/agent/deps/org/apache/commons/codec/language/bm/lang.txt", Languages.getInstance(s)));
        }
    }
