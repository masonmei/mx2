...
import com.newrelic.agent.deps.com.google.common.reflect.TypeToken;
...
public class EventBus
{
    ...
    void dispatch(final Object event, final EventSubscriber wrapper) {
        try {
            ...
            try {
                ...
                Logger.global.log(Level.SEVERE, String.format("Exception %s thrown while handling exception: %s", t, e.getCause()), t);
            }
        }
    }
    ...
    private static final class LoggingSubscriberExceptionHandler implements SubscriberExceptionHandler
    {
        ...
        public LoggingSubscriberExceptionHandler(final String identifier) {
            ...
            new StringBuilder(1 + value.length() + value2.length()).append(value).append(".").append(value2).toString();
