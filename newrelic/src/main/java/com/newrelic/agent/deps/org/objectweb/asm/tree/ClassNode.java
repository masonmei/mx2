...
public class ClassNode extends ClassVisitor
{
    ...
    public ClassNode() {
        this(327680);
        if (this.getClass() != ClassNode.class$org$objectweb$asm$tree$ClassNode) {
    ...
    static {
        ClassNode.class$org$objectweb$asm$tree$ClassNode = class$("com.newrelic.agent.deps.org.objectweb.asm.tree.ClassNode");
    }
}
