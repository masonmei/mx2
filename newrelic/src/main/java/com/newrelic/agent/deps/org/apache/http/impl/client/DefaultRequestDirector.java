...
import com.newrelic.agent.deps.org.apache.http.conn.routing.HttpRouteDirector;
import com.newrelic.agent.deps.org.apache.http.conn.routing.RouteInfo;
import com.newrelic.agent.deps.org.apache.http.conn.routing.BasicRouteDirector;
...
import com.newrelic.agent.deps.org.apache.http.conn.BasicManagedEntity;
...
import com.newrelic.agent.deps.org.apache.http.impl.auth.BasicScheme;
...
import com.newrelic.agent.deps.org.apache.http.client.params.HttpClientParams;
import com.newrelic.agent.deps.org.apache.http.client.methods.AbortableHttpRequest;
...
public class DefaultRequestDirector implements RequestDirector
{
    ...
    public HttpResponse execute(final HttpHost targetHost, final HttpRequest request, final HttpContext context) throws HttpException, IOException {
        ...
        final RequestWrapper origWrapper = this.wrapRequest(request);
