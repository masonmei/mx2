...
public final class Funnels
{
    ...
    private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(22 + value.length()).append("Funnels.stringFunnel(").append(value).append(")").toString();
        }
    ...
    private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(26 + value.length()).append("Funnels.sequentialFunnel(").append(value).append(")").toString();
        }
    ...
    private static class SinkAsStream extends OutputStream
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(24 + value.length()).append("Funnels.asOutputStream(").append(value).append(")").toString();
        }
    }
}
