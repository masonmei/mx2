...
import com.newrelic.agent.deps.com.google.common.io.ByteStreams;
...
public final class InetAddresses
{
    ...
    private static String convertDottedQuadToHex(final String ipString) {
        ...
        final String value = String.valueOf(String.valueOf(initialPart));
        final String value2 = String.valueOf(String.valueOf(penultimate));
        final String value3 = String.valueOf(String.valueOf(ultimate));
        return new StringBuilder(1 + value.length() + value2.length() + value3.length()).append(value).append(value2).append(":").append(value3).toString();
    }
    ...
    public static String toUriString(final InetAddress ip) {
        if (ip instanceof Inet6Address) {
            final String value = String.valueOf(String.valueOf(toAddrString(ip)));
            return new StringBuilder(2 + value.length()).append("[").append(value).append("]").toString();
        }
