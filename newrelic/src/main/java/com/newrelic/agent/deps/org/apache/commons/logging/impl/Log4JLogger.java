...
public class Log4JLogger implements Log, Serializable
{
    ...
    static {
        FQCN = ((Log4JLogger.class$org$apache$commons$logging$impl$Log4JLogger == null) ? (Log4JLogger.class$org$apache$commons$logging$impl$Log4JLogger = class$("com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger")) : Log4JLogger.class$org$apache$commons$logging$impl$Log4JLogger).getName();
        ...
        try {
            _traceLevel = (Priority)((Log4JLogger.class$org$apache$log4j$Level == null) ? (Log4JLogger.class$org$apache$log4j$Level = class$("org.apache.log4j.Level")) : Log4JLogger.class$org$apache$log4j$Level).getDeclaredField("TRACE").get(null);
        }
        catch (Exception ex) {
