...
public abstract class Converter<A, B> implements Function<A, B>
{
    ...
    private static final class ReverseConverter<A, B> extends Converter<B, A> implements Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(10 + value.length()).append(value).append(".reverse()").toString();
        }
    }
    ...
    private static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(10 + value.length() + value2.length()).append(value).append(".andThen(").append(value2).append(")").toString();
        }
    }
    ...
    private static final class FunctionBasedConverter<A, B> extends Converter<A, B> implements Serializable
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(18 + value.length() + value2.length()).append("Converter.from(").append(value).append(", ").append(value2).append(")").toString();
        }
    }
