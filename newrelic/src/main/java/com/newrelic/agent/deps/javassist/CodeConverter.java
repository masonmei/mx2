...
import com.newrelic.agent.deps.javassist.convert.*;
 ...
 *
 * @see com.newrelic.agent.deps.javassist.CtClass#instrument(CodeConverter)
 * @see com.newrelic.agent.deps.javassist.CtMethod#instrument(CodeConverter)
 * @see com.newrelic.agent.deps.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see com.newrelic.agent.deps.javassist.CtMethod#setName(String)
     */
