 ...
 *
 * @see com.newrelic.agent.deps.javassist.CtClass
 * @see com.newrelic.agent.deps.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see com.newrelic.agent.deps.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see com.newrelic.agent.deps.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see com.newrelic.agent.deps.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see com.newrelic.agent.deps.javassist.ByteArrayClassPath
     */
     ...
     * @see com.newrelic.agent.deps.javassist.ClassPath
     * @see com.newrelic.agent.deps.javassist.URLClassPath
     * @see com.newrelic.agent.deps.javassist.ByteArrayClassPath
     */
