...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable
{
    ...
    static {
        MapMakerInternalMap.class.getName();
    ...
    interface ReferenceEntry<K, V>
    {
        ...
        void setExpirationTime(long p0);
        
        ReferenceEntry<K, V> getNextExpirable();
        
        void setNextExpirable(ReferenceEntry<K, V> p0);
        
        ReferenceEntry<K, V> getPreviousExpirable();
        
        void setPreviousExpirable(ReferenceEntry<K, V> p0);
        
        ReferenceEntry<K, V> getNextEvictable();
        
        void setNextEvictable(ReferenceEntry<K, V> p0);
        
        ReferenceEntry<K, V> getPreviousEvictable();
        
        void setPreviousEvictable(ReferenceEntry<K, V> p0);
    }
    ...
    interface ValueReference<K, V>
    {
        ...
        void clear(@Nullable ValueReference<K, V> p0);
