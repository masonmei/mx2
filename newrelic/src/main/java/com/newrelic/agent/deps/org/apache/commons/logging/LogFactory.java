...
public abstract class LogFactory
{
    ...
    public static final String FACTORY_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.LogFactory";
    public static final String FACTORY_DEFAULT = "com.newrelic.agent.deps.org.apache.commons.logging.impl.LogFactoryImpl";
    public static final String FACTORY_PROPERTIES = "commons-logging.properties";
    protected static final String SERVICE_ID = "META-INF/services/org.apache.commons.logging.LogFactory";
    public static final String DIAGNOSTICS_DEST_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.diagnostics.dest";
    private static PrintStream diagnosticsStream;
    private static final String diagnosticPrefix;
    public static final String HASHTABLE_IMPLEMENTATION_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.LogFactory.HashtableImpl";
    private static final String WEAK_HASHTABLE_CLASSNAME = "com.newrelic.agent.deps.org.apache.commons.logging.impl.WeakHashtable";
    ...
    private static final Hashtable createFactoryStore() {
        ...
        try {
            storeImplementationClass = getSystemProperty("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory.HashtableImpl", null);
        }
        catch (SecurityException ex) {
            storeImplementationClass = null;
        }
        if (storeImplementationClass == null) {
            storeImplementationClass = "com.newrelic.agent.deps.org.apache.commons.logging.impl.WeakHashtable";
        }
        try {
            ...
            handleThrowable(t);
            if (!"com.newrelic.agent.deps.org.apache.commons.logging.impl.WeakHashtable".equals(storeImplementationClass)) {
    ...
    public static LogFactory getFactory() throws LogConfigurationException {
        ...
        try {
            final String factoryClass = getSystemProperty("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory", null);
            if (factoryClass != null) {
                if (isDiagnosticsEnabled()) {
                    logDiagnostic("[LOOKUP] Creating an instance of LogFactory class '" + factoryClass + "' as specified by system property " + "com.newrelic.agent.deps.org.apache.commons.logging.LogFactory");
                }
        ...
        if (factory == null) {
            if (props != null) {
                ...
                final String factoryClass = props.getProperty("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory");
                if (factoryClass != null) {
                    if (isDiagnosticsEnabled()) {
        ...
        if (factory == null) {
            ...
            factory = newFactory("com.newrelic.agent.deps.org.apache.commons.logging.impl.LogFactoryImpl", LogFactory.thisClassLoader, contextClassLoader);
        }
        if (factory != null) {
    ...
    protected static ClassLoader directGetContextClassLoader() throws LogConfigurationException {
        ...
        try {
            final Method method = ((LogFactory.class$java$lang$Thread == null) ? (LogFactory.class$java$lang$Thread = class$("java.lang.Thread")) : LogFactory.class$java$lang$Thread).getMethod("getContextClassLoader", (Class[])null);
            try {
            ...
            classLoader = getClassLoader((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory);
        }
        return classLoader;
    }
        ...
        try {
            if (classLoader != null) {
                try {
                    ...
                    if (((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory).isAssignableFrom(logFactoryClass)) {
                        if (isDiagnosticsEnabled()) {
                            logDiagnostic("Loaded class " + logFactoryClass.getName() + " from classloader " + objectId(classLoader));
                        }
                    }
                    else if (isDiagnosticsEnabled()) {
                        logDiagnostic("Factory class " + logFactoryClass.getName() + " loaded from classloader " + objectId(logFactoryClass.getClassLoader()) + " does not extend '" + ((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory).getName() + "' as loaded by this classloader.");
                    ...
                    if (classLoader == LogFactory.thisClassLoader) {
                        ...
                        msg.append(((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory).getName());
                        msg.append("'. ");
            ...
            if (logFactoryClass != null && !((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory).isAssignableFrom(logFactoryClass)) {
        ...
        if (logFactoryClass != null) {
            try {
                ...
                if (logFactoryClassLoader == null) {
                    ...
                    final Class factoryFromCustomLoader = Class.forName("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory", false, logFactoryClassLoader);
    ...
    private static PrintStream initDiagnostics() {
        String dest;
        try {
            dest = getSystemProperty("com.newrelic.agent.deps.org.apache.commons.logging.diagnostics.dest", null);
            if (dest == null) {
                return null;
            }
        }
    ...
    static {
        ...
        LogFactory.nullClassLoaderFactory = null;
        thisClassLoader = getClassLoader((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory);
        ...
        logClassLoaderEnvironment((LogFactory.class$org$apache$commons$logging$LogFactory == null) ? (LogFactory.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactory.class$org$apache$commons$logging$LogFactory);
