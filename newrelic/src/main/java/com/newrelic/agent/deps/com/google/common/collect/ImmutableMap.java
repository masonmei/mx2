...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable
{
    ...
    static void checkNoConflict(final boolean safe, final String conflictDescription, final Entry<?, ?> entry1, final Entry<?, ?> entry2) {
        if (!safe) {
            final String value = String.valueOf(String.valueOf(conflictDescription));
            final String value2 = String.valueOf(String.valueOf(entry1));
            final String value3 = String.valueOf(String.valueOf(entry2));
            throw new IllegalArgumentException(new StringBuilder(34 + value.length() + value2.length() + value3.length()).append("Multiple entries with same ").append(value).append(": ").append(value2).append(" and ").append(value3).toString());
        }
    }
