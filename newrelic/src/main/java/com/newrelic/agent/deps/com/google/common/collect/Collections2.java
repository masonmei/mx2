...
import com.newrelic.agent.deps.com.google.common.math.LongMath;
...
public final class Collections2
{
    ...
    static class FilteredCollection<E> extends AbstractCollection<E>
    {
        ...
        public boolean contains(@Nullable final Object element) {
            return Collections2.safeContains(this.unfiltered, element) && this.predicate.apply((Object)element);
        }
    ...
    private static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>>
    {
        ...
        public String toString() {
            ...
            return new StringBuilder(30 + value.length()).append("orderedPermutationCollection(").append(value).append(")").toString();
        }
    }
    ...
    private static final class PermutationCollection<E> extends AbstractCollection<List<E>>
    {
        ...
        public String toString() {
            final String value = String.valueOf(String.valueOf(this.inputList));
            return new StringBuilder(14 + value.length()).append("permutations(").append(value).append(")").toString();
        }
    }
