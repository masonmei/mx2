...
public final class MapMaker extends GenericMapMaker<Object, Object>
{
    ...
    static final class ComputingMapAdapter<K, V> extends ComputingConcurrentHashMap<K, V> implements Serializable
    {
        ...
        public V get(final Object key) {
            ...
            if (value == null) {
                final String value2 = String.valueOf(String.valueOf(this.computingFunction));
                final String value3 = String.valueOf(String.valueOf(key));
                throw new NullPointerException(new StringBuilder(24 + value2.length() + value3.length()).append(value2).append(" returned null for key ").append(value3).append(".").toString());
            }
            return value;
        }
    }
