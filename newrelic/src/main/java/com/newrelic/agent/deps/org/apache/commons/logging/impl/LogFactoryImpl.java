...
package com.newrelic.agent.deps.org.apache.commons.logging.impl;
...
{
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger";
    private static final String LOGGING_IMPL_JDK14_LOGGER = "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger";
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk13LumberjackLogger";
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "com.newrelic.agent.deps.org.apache.commons.logging.impl.SimpleLog";
    private static final String PKG_IMPL = "com.newrelic.agent.deps.org.apache.commons.logging.impl.";
    private static final int PKG_LEN;
    public static final String LOG_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.Log";
    protected static final String LOG_PROPERTY_OLD = "com.newrelic.agent.deps.org.apache.commons.logging.log";
    public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedContext";
    public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedDiscovery";
    public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = "com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedHierarchy";
    ...
    public LogFactoryImpl() {
        ...
        this.logMethod = null;
        this.logMethodSignature = new Class[] { (LogFactoryImpl.class$org$apache$commons$logging$LogFactory == null) ? (LogFactoryImpl.class$org$apache$commons$logging$LogFactory = class$("com.newrelic.agent.deps.org.apache.commons.logging.LogFactory")) : LogFactoryImpl.class$org$apache$commons$logging$LogFactory };
    ...
    protected boolean isJdk13LumberjackAvailable() {
        return this.isLogLibraryAvailable("Jdk13Lumberjack", "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
    }
    
    protected boolean isJdk14Available() {
        return this.isLogLibraryAvailable("Jdk14", "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger");
    }
    
    protected boolean isLog4JAvailable() {
        return this.isLogLibraryAvailable("Log4J", "com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger");
    }
    ...
    private void initConfiguration() {
        this.allowFlawedContext = this.getBooleanConfiguration("com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedContext", true);
        this.allowFlawedDiscovery = this.getBooleanConfiguration("com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedDiscovery", true);
        this.allowFlawedHierarchy = this.getBooleanConfiguration("com.newrelic.agent.deps.org.apache.commons.logging.Log.allowFlawedHierarchy", true);
    }
    ...
    private Log discoverLogImplementation(final String logCategory) throws LogConfigurationException {
        ...
        if (specifiedLogClassName != null) {
            ...
            if (result == null) {
                ...
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
                this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.newrelic.agent.deps.org.apache.commons.logging.impl.SimpleLog");
    ...
    private String findUserSpecifiedLogClassName() {
        ...
        String specifiedClass = (String)this.getAttribute("com.newrelic.agent.deps.org.apache.commons.logging.Log");
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
                this.logDiagnostic("Trying to get log class from attribute 'org.apache.commons.logging.log'");
            }
            specifiedClass = (String)this.getAttribute("com.newrelic.agent.deps.org.apache.commons.logging.log");
        }
        if (specifiedClass == null) {
            if (isDiagnosticsEnabled()) {
            ...
            try {
                specifiedClass = getSystemProperty("com.newrelic.agent.deps.org.apache.commons.logging.Log", null);
            }
            catch (SecurityException e) {
                if (isDiagnosticsEnabled()) {
    ...
    private ClassLoader getBaseClassLoader() throws LogConfigurationException {
        final ClassLoader thisClassLoader = getClassLoader((LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl == null) ? (LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl = class$("com.newrelic.agent.deps.org.apache.commons.logging.impl.LogFactoryImpl")) : LogFactoryImpl.class$org$apache$commons$logging$impl$LogFactoryImpl);
        if (!this.useTCCL) {
    ...
    private void handleFlawedHierarchy(final ClassLoader badClassLoader, final Class badClass) throws LogConfigurationException {
        ...
        final String logInterfaceName = ((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("com.newrelic.agent.deps.org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log).getName();
        ...
        if (implementsLog) {
            if (isDiagnosticsEnabled()) {
                try {
                    final ClassLoader logInterfaceClassLoader = getClassLoader((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("com.newrelic.agent.deps.org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log);
            ...
            if (!this.allowFlawedHierarchy) {
                ...
                msg.append(((LogFactoryImpl.class$org$apache$commons$logging$Log == null) ? (LogFactoryImpl.class$org$apache$commons$logging$Log = class$("com.newrelic.agent.deps.org.apache.commons.logging.Log")) : LogFactoryImpl.class$org$apache$commons$logging$Log).getName());
                msg.append("' visible.");
                if (isDiagnosticsEnabled()) {
    ...
    static {
        PKG_LEN = "com.newrelic.agent.deps.org.apache.commons.logging.impl.".length();
        classesToDiscover = new String[] { "com.newrelic.agent.deps.org.apache.commons.logging.impl.Log4JLogger", "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk14Logger", "com.newrelic.agent.deps.org.apache.commons.logging.impl.Jdk13LumberjackLogger", "com.newrelic.agent.deps.org.apache.commons.logging.impl.SimpleLog" };
    }
}
