...
import com.newrelic.agent.deps.com.google.common.collect.Iterators;
import com.newrelic.agent.deps.com.google.common.collect.ImmutableSetMultimap;
import com.newrelic.agent.deps.com.google.common.collect.Serialization;
...
import com.newrelic.agent.deps.com.google.common.collect.CollectPreconditions;
import java.util.Comparator;
import com.newrelic.agent.deps.com.google.common.collect.Lists;
import java.util.LinkedHashMap;
import com.newrelic.agent.deps.com.google.common.collect.AbstractMapBasedMultimap;
import java.util.Set;
import com.newrelic.agent.deps.com.google.common.collect.Multiset;
import com.newrelic.agent.deps.com.google.common.collect.UnmodifiableIterator;
import com.newrelic.agent.deps.com.google.common.collect.ImmutableCollection;
import com.newrelic.agent.deps.com.google.common.collect.ImmutableMap;
import java.io.Serializable;
import com.newrelic.agent.deps.com.google.common.collect.AbstractMultimap;
...
import com.newrelic.agent.deps.com.google.common.base.Ascii;
...
import com.newrelic.agent.deps.com.google.common.base.Optional;
import com.newrelic.agent.deps.com.google.common.collect.Maps;
import java.util.Collection;
import com.newrelic.agent.deps.com.google.common.base.Function;
import com.newrelic.agent.deps.com.google.common.collect.ImmutableMultiset;
...
import com.newrelic.agent.deps.com.google.common.collect.ImmutableListMultimap;
...
public final class MediaType
{
    ...
    public Optional<Charset> charset() {
        ...
        switch (charsetValues.size()) {
            ...
            default: {
                final String value = String.valueOf(String.valueOf(charsetValues));
                throw new IllegalStateException(new StringBuilder(33 + value.length()).append("Multiple charset values defined: ").append(value).toString());
            }
        }
    }
    ...
    public static MediaType parse(final String input) {
        ...
        try {
            ...
            final String value2 = String.valueOf(String.valueOf(input));
            throw new IllegalArgumentException(new StringBuilder(18 + value2.length()).append("Could not parse '").append(value2).append("'").toString(), e);
        }
    }
