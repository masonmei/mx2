...
public abstract class FluentIterable<E> implements Iterable<E>
{
    ...
    public final FluentIterable<E> append(final Iterable<? extends E> other) {
        return from(Iterables.concat((Iterable<? extends E>)this.iterable, other));
    }
    
    @CheckReturnValue
    @Beta
    public final FluentIterable<E> append(final E... elements) {
        return from(Iterables.concat((Iterable<? extends E>)this.iterable, (Iterable<? extends E>)Arrays.asList(elements)));
    }
