...
final class Types
{
    ...
    static <D extends GenericDeclaration> TypeVariable<D> newArtificialTypeVariable(final D declaration, final String name, final Type... bounds) {
        final Type[] bounds2;
        if (bounds.length == 0) {
            bounds2 = new Type[] { Object.class };
        }
        return new TypeVariableImpl<D>(declaration, name, bounds2);
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable
    {
        ...
        public String toString() {
            ...
            builder.append(this.rawType.getName()).append('<').append(Types.COMMA_JOINER.join(Iterables.transform((Iterable<Type>)this.argumentsList, (Function<? super Type, ?>)Types.TYPE_NAME))).append('>');
