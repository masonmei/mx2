...
package com.newrelic.agent.deps.com.google.common.base.internal;
...
public class Finalizer implements Runnable
{
    ...
    private static final String FINALIZABLE_REFERENCE = "com.newrelic.agent.deps.com.google.common.base.FinalizableReference";
    ...
    public static void startFinalizer(final Class<?> finalizableReferenceClass, final ReferenceQueue<Object> queue, final PhantomReference<Object> frqReference) {
        if (!finalizableReferenceClass.getName().equals("com.newrelic.agent.deps.com.google.common.base.FinalizableReference")) {
