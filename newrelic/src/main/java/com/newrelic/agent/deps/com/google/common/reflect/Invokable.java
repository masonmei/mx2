...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration
{
    ...
    public final <R1 extends R> Invokable<T, R1> returning(final TypeToken<R1> returnType) {
        if (!returnType.isAssignableFrom(this.getReturnType())) {
            ...
            final String value2 = String.valueOf(String.valueOf(returnType));
            throw new IllegalArgumentException(new StringBuilder(35 + value.length() + value2.length()).append("Invokable is known to return ").append(value).append(", not ").append(value2).toString());
        }
    ...
    static class ConstructorInvokable<T> extends Invokable<T, T>
    {
        ...
        final Object invokeInternal(@Nullable final Object receiver, final Object[] args) throws InvocationTargetException, IllegalAccessException {
            try {
                ...
                throw new RuntimeException(new StringBuilder(8 + value.length()).append(value).append(" failed.").toString(), e);
            }
        }
