...
public class ServiceManagerImpl extends AbstractService implements ServiceManager
{
    ...
    public ServiceManagerImpl(final IAgent agent) throws ConfigurationException {
    ...
    protected synchronized void doStart() throws Exception {
        ...
        final boolean realAgent = this.agentService.getInstrumentation() != null;
        this.statsService = new StatsServiceImpl();
        this.replayStartupStatsWork();
        (this.utilizationService = new UtilizationService()).start();
    ...
    private void startServices() throws Exception {
        for (final Service service : this.getServices().values()) {
            service.start();
        }
    }
    ...
    private Map<String, Service> getServices() {
        return Collections.unmodifiableMap((Map<? extends String, ? extends Service>)this.services);
    }
    ...
    public synchronized Service getService(final String name) {
    ...
    private void replayStartupStatsWork() {
        for (final StatsWork work : this.statsWork) {
