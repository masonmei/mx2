...
{
    public ConcurrentCallablePointCut(final ClassTransformer classTransformer) {
        super(new PointCutConfiguration(ConcurrentCallablePointCut.class.getName(), null, false), new OrClassMatcher(new ClassMatcher[] { new ExactClassMatcher("java/util/concurrent/Executors$RunnableAdapter"), new InterfaceMatcher("java/util/concurrent/Callable") }), PointCut.createExactMethodMatcher("call", "()Ljava/lang/Object;"));
    }
