...
public class AnormResultSetParsePointCut extends TracerFactoryPointCut
{
    ...
    public AnormResultSetParsePointCut(final ClassTransformer classTransformer) {
        super(createPointCutConfig(), createClassMatcher(), createMethodMatcher());
    }
    
    private static PointCutConfiguration createPointCutConfig() {
        return new PointCutConfiguration(AnormResultSetParsePointCut.POINT_CUT_NAME, "play2_instrumentation", true);
    }
    ...
    static {
        POINT_CUT_NAME = AnormResultSetParsePointCut.class.getName();
    }
}
