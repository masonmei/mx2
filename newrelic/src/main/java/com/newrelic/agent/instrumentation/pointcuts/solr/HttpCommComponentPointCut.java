...
public class HttpCommComponentPointCut extends AbstractSolrPointCut
{
    public HttpCommComponentPointCut(final ClassTransformer classTransformer) {
        super(HttpCommComponentPointCut.class, new ExactClassMatcher("org/apache/solr/handler/component/HttpCommComponent"), PointCut.createExactMethodMatcher("submit", "(Lorg/apache/solr/handler/component/ShardRequest;Ljava/lang/String;Lorg/apache/solr/common/params/ModifiableSolrParams;)V"));
    }
