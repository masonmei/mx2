...
public class ObjectFactory
{
    ...
    public Extension.Instrumentation.Pointcut.Method.Parameters createExtensionInstrumentationPointcutMethodParameters() {
    ...
    public Extension.Instrumentation.Pointcut.Method.Parameters.Type createExtensionInstrumentationPointcutMethodParametersType() {
