...
public final class ClassMethodSignature
{
    ...
    public ClassMethodSignature(final String className, final String methodName, final String methodDesc) {
    ...
    public boolean equals(final Object obj) {
        ...
        final ClassMethodSignature other = (ClassMethodSignature)obj;
    ...
    public MetricNameFormat getMetricNameFormat(final Object invocationTarget, final int flags) {
